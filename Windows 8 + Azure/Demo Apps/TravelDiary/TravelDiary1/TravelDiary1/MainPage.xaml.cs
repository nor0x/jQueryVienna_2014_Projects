...
namespace TravelDiary1
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        //Database Table for Windows Azure
        private IMobileServiceTable<PlaceItem> placeTable = App.traveldiaryClient.GetTable<PlaceItem>();
        ...
        private async void InsertDataAsync(Place p)
        {
        ...
        private async Task<List<PlaceItem>> GetListAsync()
        {
            return await placeTable.ToListAsync();
        }
        #endregion
    }
}
